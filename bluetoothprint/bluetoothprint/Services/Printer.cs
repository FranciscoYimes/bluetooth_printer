...
namespace bluetoothprint.Services
{
    public class Printer
    {
        ...
        public async Task PrintDte(Dte dte)
        {
            await _blueToothService.Print(MyPrinter, dte);
        }
        ...
        public async Task writeBytes(byte[] valueToWrite)
        {
            await _blueToothService.Print(MyPrinter, valueToWrite);
